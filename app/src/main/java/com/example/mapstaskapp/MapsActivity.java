...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, View.OnTouchListener {
    ...
    public void loadPreferences() {
        ...
        float lat = prefs.getFloat("lat", 33);
        float longg = prefs.getFloat("long", -117);
    ...
    public void goToDisneyLand() {
        LatLng disneyland = new LatLng(33, -117);
        mMap.addMarker(new MarkerOptions().position(disneyland).title("Disneyland"));
